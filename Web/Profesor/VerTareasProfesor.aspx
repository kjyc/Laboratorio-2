    ...
    <form id="form1" runat="server">
        <div class="container mt-5">
            ...
            <div class="row text-center bg-secondary rounded align-items-center mt-4 p-2">
                ...
                <div class="col-2">
                    <a href="/Profesor/Estadisticas.aspx" class="btn btn-dark">Ver estadisticas</a>
                </div>
            </div>
                ...
                <ContentTemplate>
                    <div class="row p-5">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlSubjects" runat="server" DataSourceID="sdsSubjects" DataTextField="codigoAsig" DataValueField="codigoAsig" AutoPostBack="True">
                            </asp:DropDownList>
